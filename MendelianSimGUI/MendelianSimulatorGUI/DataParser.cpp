...
{
	static DataParser *theInstance = NULL;
	if(theInstance == NULL)
	{
		theInstance = new DataParser();
	}
	return theInstance;
}
...
//====================================================================
void DataParser::initDataFile(char *fileName)
{
	char line[128];
...
//====================================================================
int DataParser::getChromosomeCount()
{
...
//====================================================================
char *DataParser::getScientificName()
{
...
//====================================================================
bool DataParser::getGeneData(char *trait, char *domDesc, char *domSymbol, 
										char *recDesc, char *recSymbol, char *coChance)
{
	int gNum = 0;
	char line[128];
				...
				if(gNum == m_iNextGeneNumber)
				{
					...
					while(getNextLine(line, 127))
					{
						...
						else if(strcmp(line, "<CROSSOVER_CHANCE>") == 0)
						{
							...
							{
								//printf("Line: %s\n", line);
								//*coChance = atoi(line); // Set the cross-over chance
								strcpy(coChance, line);
								//printf("COChance Parser: %s\n", coChance);
...
//						chromosome.
//====================================================================
bool DataParser::getP1Chromosome(char *strand1, char *strand2)
{
	int cNum = 0;
	char line[128];
...
//						chromosome.
//====================================================================
bool DataParser::getP2Chromosome(char *strand1, char *strand2)
{
	int cNum = 0;
	char line[128];
